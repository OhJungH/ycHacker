...
public class TempUserDto {
	...
	public TempUserDto(int userNum, String userId, String userPw, String userAuth, String userName, String userPhone,
	...
	public TempUserDto(String userId, String userPw, String userAuth) {
		super();
		this.userId = userId;
		this.userPw = userPw;
		this.userAuth = userAuth;
